...
```
Build the Intelligence layer. Read C:\Personal\NexusAI\docs\NEXUS_ARCHITECTURE_V2.md
...
directly. Read C:\Personal\NexusAI\docs\NEXUS_ARCHITECTURE_V2.md section 5 first.
...
```
Rework the React client. Read C:\Personal\NexusAI\docs\NEXUS_ARCHITECTURE_V2.md section 8.
